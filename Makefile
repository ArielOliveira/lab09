...
arielslib.a: $(SRC_DIR)/main_lib.cpp $(INC_DIR)/arielslib_list.h $(INC_DIR)/arielslib_stack.h $(INC_DIR)/arielslib_queue.h $(INC_DIR)/arielslib_merge_sort.h $(INC_DIR)/arielslib_quick_sort.h $(INC_DIR)/arielslib_binary_search.h
...
arielslib.so: $(SRC_DIR)/main_lib.cpp $(INC_DIR)/arielslib_list.h $(INC_DIR)/arielslib_stack.h $(INC_DIR)/arielslib_queue.h $(INC_DIR)/arielslib_merge_sort.h $(INC_DIR)/arielslib_quick_sort.h $(INC_DIR)/arielslib_binary_search.h
